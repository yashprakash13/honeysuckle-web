...
class StoryRating(models.Model):
    ...
    rating = models.CharField(
        max_length=50, choices=RATING_CHOICES, null=True, blank=True
    )
    story_id = models.CharField(max_length=30)
    created_by = models.ForeignKey(
        Member, on_delete=models.CASCADE, related_name="StoryRating"
    )
...
class StoryContrib(models.Model):
    ...
    given_by = models.ForeignKey(
        Member, on_delete=models.CASCADE, related_name="StoryContrib"
    )
...
class Folder(models.Model):
    ...
    created_by = models.ForeignKey(
        Member, on_delete=models.CASCADE, related_name="Folders"
    )
